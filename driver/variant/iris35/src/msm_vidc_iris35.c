...
static int msm_vidc_decide_work_mode_iris35(struct msm_vidc_inst *inst)
{
	u32 work_mode;
...
static int msm_vidc_decide_work_route_iris35(struct msm_vidc_inst *inst)
{
	u32 work_route;
...
static int msm_vidc_decide_quality_mode_iris35(struct msm_vidc_inst *inst)
{
	struct msm_vidc_core *core;
