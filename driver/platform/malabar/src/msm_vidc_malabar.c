...
static struct msm_platform_inst_capability instance_cap_data_malabar[] = {
	...
	{OUTPUT_RX_FENCE_ENABLE, DEC, H264 | HEVC | VP9,
		0, 1, 1, 0,
	...
	{INPUT_RX_FENCE_ENABLE, DEC, H264 | HEVC | VP9,
		0, 1, 1, 0,
	...
	/* enable input rx fence feature */
	{INPUT_TX_FENCE_ENABLE, DEC, H264 | HEVC | VP9,
		0, 1, 1, 0,
	 ...
	 */
	{INPUT_RX_FENCE_FD, DEC, H264 | HEVC | VP9 | HEIC,
		INVALID_FD, INT_MAX, 1, INVALID_FD,
	...
	{INPUT_RX_FENCE_TYPE, DEC, H264 | HEVC | VP9,
	...
	{INPUT_TX_FENCE_TYPE, DEC, H264 | HEVC | VP9,
		MSM_VIDC_FENCE_NONE, MSM_VIDC_SYNX_V2_FENCE,
		BIT(MSM_VIDC_FENCE_NONE) | BIT(MSM_VIDC_SW_FENCE) |
			BIT(MSM_VIDC_SYNX_V2_FENCE),
		MSM_VIDC_FENCE_NONE,
	...
	{OUTPUT_RX_FENCE_TYPE, DEC, H264 | HEVC | VP9,
		MSM_VIDC_FENCE_NONE, MSM_VIDC_SYNX_V2_FENCE,
		BIT(MSM_VIDC_FENCE_NONE) | BIT(MSM_VIDC_SW_FENCE) |
			BIT(MSM_VIDC_SYNX_V2_FENCE),
		MSM_VIDC_FENCE_NONE,
	...
	{EARLY_NOTIFY_ENABLE, DEC, H264 | HEVC,
	...
	{EARLY_NOTIFY_LINE_COUNT, DEC, H264 | HEVC,
		0, 8192, 256, 0,
		V4L2_CID_MPEG_VIDC_EARLY_NOTIFY_LINE_COUNT,
		HFI_PROP_EARLY_NOTIFY_LINE_COUNT,
		CAP_FLAG_INPUT_PORT | CAP_FLAG_DYNAMIC_ALLOWED},

	{EARLY_NOTIFY_FENCE_COUNT, DEC, H264 | HEVC,
...
static struct msm_platform_inst_cap_dependency instance_cap_dependency_data_malabar[] = {
	...
	{META_OUTPUT_TX_FENCE, DEC, H264 | HEVC,
